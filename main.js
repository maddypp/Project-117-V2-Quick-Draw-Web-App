...
random_array = quick_draw_data_set[random];
...
function updateCanvas() {
    background('white');
    randomnum = Math.floor(Math.random()*quick_draw_data_set.length);
    console.log(quick_draw_data_set[randomnum]);
    sketch = quick_draw_data_set[randomnum];
    document.getElementById("draw").innerHTML = "sketch to be drawn: " + sketch;
}
...
function gotresults(error,results) {
    if (error) {
        ...
        drawn_skecth = results[0].label;
        document.getElementById("your_sketch").innerHTML = "your sketch: " + results[0].label;
        document.getElementById("Confidence").innerHTML = "confidence: " + results[0].conficence;
    }
}